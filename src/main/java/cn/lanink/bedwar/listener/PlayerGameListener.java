...
import cn.lanink.bedwar.tasks.game.ScanTask;
...
public class PlayerGameListener implements Listener {
    ...
    public PlayerGameListener(BedWars murderMystery) {
                ...
                if (room.isPlaying(player1) && room.getPlayerMode(player1) == 3 &&
                    ...
                    if (player1.getInventory().getItemInHand() != null) {
                        ...
                        if (tag != null && tag.getBoolean("isMurderItem") && tag.getInt("MurderType") == 2) {
                            Server.getInstance().getPluginManager().callEvent(new BedWarPlayerDamageEvent(room, player1, player2));
                        }
                    }
                }
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        Room room = this.murderMystery.getRooms().get(level.getName());
        CompoundTag tag = item.getNamedTag();
