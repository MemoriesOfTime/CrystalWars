...
import cn.lanink.bedwar.entity.EntityText;
...
public class ScanTask extends AsyncTask {
    ...
    public void onRun() {
        ...
        this.player.sendMessage(BedWars.getInstance().getLanguage().useItemScan);
        Server.getInstance().getScheduler().scheduleDelayedTask(BedWars.getInstance(), new Task() {
            @Override
